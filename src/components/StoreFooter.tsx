...
export default function StoreFooter() {
  return <footer className="store-footer">
    <div className="store-footer-top">
      ...
      <div><h4>Kurumsal</h4><Link href="/hakkimizda">Hakkımızda</Link><Link href="/blog">Blog</Link><Link href="/kvkk">KVKK</Link><Link href="/mesafeli-satis">Mesafeli Satış</Link></div>
    </div>
