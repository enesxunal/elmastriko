...
export default function ContactPage() {
  return <><StoreHeader/><main className="content-page">
    <section className="content-hero"><span>İLETİŞİM</span><h1>Elmas Triko’ya ulaşın.</h1><p>Ürün, sipariş, teslimat ve satış sonrası konular için iletişim bilgileri ürün yayını öncesinde burada tamamlanacaktır.</p></section>
