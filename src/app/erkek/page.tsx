...
export const metadata: Metadata = { title: "Erkek Triko Koleksiyonu", description: "Elmas Triko erkek koleksiyonu: yeni sezon erkek triko ve zamansız parçalar.", alternates: { canonical: "/erkek" } };
