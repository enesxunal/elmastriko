...
export default function CheckoutPage() {
  ...
  return <><StoreHeader/><main className="checkout-page">
    <section className="checkout-main">
      ...
      <div className="checkout-step payment-step"><span>04</span><div><h2>Ödeme</h2><div className="provider-waiting"><b>Tosla İşim Sanal POS hazırlanıyor</b><p>3D ödeme başlangıç, callback ve ödeme doğrulama altyapısı hazır. Merchant bilgileri tanımlandığında kart ödeme adımı aktif edilecek.</p></div></div></div>
    </section>
